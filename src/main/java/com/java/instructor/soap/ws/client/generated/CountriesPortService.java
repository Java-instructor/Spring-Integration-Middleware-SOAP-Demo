 ...
 * 
 */
@WebServiceClientTest(name = "CountriesPortService", targetNamespace = "http://www.javainstructor.com/springsoap/gen", wsdlLocation = "file:/D:/amazeSpringWorkingProjects/SOAPServiceSpringIntegration/src/main/resources/countries.wsdl")
    ...
    extends Service
{
    ...
    private final static QName COUNTRIESPORTSERVICE_QNAME = new QName("http://www.javainstructor.com/springsoap/gen", "CountriesPortService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/amazeSpringWorkingProjects/SOAPServiceSpringIntegration/src/main/resources/countries.wsdl");
    ...
    public CountriesPort getCountriesPortSoap11() {
        return super.getPort(new QName("http://www.javainstructor.com/springsoap/gen", "CountriesPortSoap11"), CountriesPort.class);
    }
    ...
    public CountriesPort getCountriesPortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.javainstructor.com/springsoap/gen", "CountriesPortSoap11"), CountriesPort.class, features);
    }
